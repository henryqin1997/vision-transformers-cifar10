...
parser.add_argument('--ratio', type=float, default=0.655)
...
trainset = InfoBatch(trainset, 0.5, args.n_epochs, 0.875)

# trainloader = torch.utils.data.DataLoader(trainset, batch_size=bs, shuffle=True, num_workers=8)

trainloader = torch.utils.data.DataLoader(
    trainset, batch_size=bs, sampler = trainset.pruning_sampler())
